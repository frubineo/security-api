# Production Checklist for security-api
Write-Host "Production Checklist for security-api" -ForegroundColor Cyan
...
Test-Requirement "Archive" ((Get-ChildItem -Name "security-api-v1.0.0-production-certified-*.zip" -ErrorAction SilentlyContinue).Count -gt 0)
