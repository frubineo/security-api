# Certification Archive Generator for security-api
Write-Host "Generating certification archive for security-api..." -ForegroundColor Green

$ProjectName = "security-api"
$Version = "v1.0.0"
...
$CertificationManifest = "# security-api Certification Manifest
